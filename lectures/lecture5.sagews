︠f81acc83-2547-4364-8d25-50e000182ecf︠
︠0b6ff52c-4a8a-40f7-88a8-16cac35d6527︠
%md
...
︠76875617-91d1-4d16-bcec-ff4014932497︠
...
#    try, catch, throw....
︠4aaab498-cfdc-4300-a9fc-c1866eea4509︠
# cause an exception
try:
    1/0
except:
...
︠c6deb240-b952-407d-bff7-bb05be3c303d︠
for A in range(-5,5):
    for B in range(-5,5):
        try:
            E = EllipticCurve([A,B])
...
︠9243c7a2-3402-4ac1-8d9e-fdee9c0e4a87︠
try:
    1/0
...
︠03dd4894-9207-4505-be9d-930d25cec972︠
...
︠149a6543-5016-4b75-974f-5b9b49dca960︠
try:
    eval('2/')
...
︠2bd999b7-d8e5-4d01-91e3-68696393b1e8︠
try:
    eval('2/')
except ArithmeticError:
    print "arith error"
...
︠3d19f3de-4005-4d48-8245-0b7f32f74256︠
def f(s):
    try:
...
︠d339f24b-94e5-4f0e-993b-3c423cb45bf0︠
f('2+3')
...
︠5c24d4f5-664f-48e7-94f5-6bb04731d55f︠
f(2/3)
...
︠c0657fbe-2b78-4081-b1c9-04c8bc55d0de︠
...
︠fc5c1e3d-0109-42b0-abb1-0d803598709c︠
def invert_in_ZZ(z):
    if z == -1 or z == 1:
        return z
    else:
...
︠1d221fa2-34f0-4e84-9c7b-a5fb71156107︠
a = 2^10000000
...
︠9bb3c80f-ac05-4f14-8b1c-c42898e115db︠
md("""
...
︠d051cda1-bf60-4e41-bc1e-ad46ecf79fd6︠
%md
