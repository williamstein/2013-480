...
︠c8df8a96-7abf-4dc0-a565-95d15a84a866r︠
...
︡09670749-9039-442f-b7d8-1dfe05754ba0︡{"done":false,"event":"output"}︡{"done":false,"event":"output","stderr":"Error in lines 2-2\n"}︡{"done":false,"event":"output","stderr":"Traceback (most recent call last):\n"}︡{"done":false,"event":"output","stderr":"  File \"/home/wstein/.sagemathcloud/sage_server.py\", line 406, in execute\n"}︡{"done":false,"event":"output","stderr":"    exec compile(block, '', 'single') in namespace, locals\n"}︡{"done":false,"event":"output","stderr":"  File \"\", line 1, in <module>\n"}︡{"done":false,"event":"output","stderr":"  File \"element.pyx\", line 1797, in sage.structure.element.RingElement.__div__ (sage/structure/element.c:14834)\n"}︡{"done":false,"event":"output","stderr":"  File \"integer.pyx\", line 1786, in sage.rings.integer.Integer._div_ (sage/rings/integer.c:13151)\n"}︡{"done":false,"event":"output","stderr":"  File \"integer_ring.pyx\", line 347, in sage.rings.integer_ring.IntegerRing_class._div (sage/rings/integer_ring.c:5715)\n"}︡{"done":false,"event":"output","stderr":"ZeroDivisionError: Rational division by zero\n"}︡{"stdout":"","done":true,"event":"output"}︡
︠9243c7a2-3402-4ac1-8d9e-fdee9c0e4a87r︠
try:
    1/0
except ZeroDivisionError, err:
    print "err =", err
︡895d3769-e88e-4ac7-b1c4-0948855eb0d1︡{"done":false,"event":"output"}︡{"stdout":"err =","done":false,"event":"output"}︡{"stdout":" ","done":false,"event":"output"}︡{"stdout":"Rational division by zero","done":false,"event":"output"}︡{"stdout":"\n","done":false,"event":"output"}︡{"stdout":"","done":true,"event":"output"}︡
...
try:
    ...
    print "err =", err
︡38c5d1f9-0964-4022-8cf3-2461ca42aa6e︡{"done":false,"event":"output"}︡{"stdout":"err =","done":false,"event":"output"}︡{"stdout":" ","done":false,"event":"output"}︡{"stdout":"Rational division by zero","done":false,"event":"output"}︡{"stdout":"\n","done":false,"event":"output"}︡{"stdout":"","done":true,"event":"output"}︡
...
︡cb90f091-1cdf-4cd2-aafc-a68bfcb28abc︡{"done":false,"event":"output"}︡{"stdout":"","done":true,"event":"output"}︡
︠d339f24b-94e5-4f0e-993b-3c423cb45bf0r︠
f('2+3')
︡42be9669-32ec-4dc7-a90d-4afe8fbda8f6︡{"done":false,"event":"output"}︡{"stdout":"I will be run no matter what!","done":false,"event":"output"}︡{"stdout":"\n","done":false,"event":"output"}︡{"stdout":"5","done":false,"event":"output"}︡{"stdout":"\n","done":false,"event":"output"}︡{"stdout":"","done":true,"event":"output"}︡
