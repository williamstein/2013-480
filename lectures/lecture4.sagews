...
︠a2f091d1-699f-473e-8a6a-8b0fa7fe2778︠md("""
# Today's Goals:
...
︠5910d639-455d-4cdc-a6f5-a1e82a946d11︠
...
︠6b7fd8d4-f32f-4826-81a9-533b8564b80d︠def f(x, y, *args, **kwds):
    print locals()
...
︠8702e82d-6525-4f37-8d02-04d6e3614afe︠
f('hello', 'y', a=5, bc=17)
...
︠ff36e3fd-748e-41e2-949e-0be1eab62680︠
...
︠46efc1b6-436d-496c-a9fd-d5fdce0fe50c︠
%md
...
︠59ac4c7a-ae5f-44be-8957-88d26c8145da︠
...
︠f739fc52-7903-4357-aaf5-6f21f62dd10a︠
f = (x+y)^7; show(f)
...
︠884a4110-dce2-4f55-8e6b-9dd0ef985977︠
preparse('R.0')
f = R.0 + 2*R.1; f
...
︠08b28552-bc55-44e0-b1d2-7892761c4e9e︠
...
︠5aa5724f-e9c9-4dec-a082-712f303415b1︠
...
︠f6d0b0b2-6f75-47be-8dce-6aa555116c4d︠def f(a,b,c, really=True):
    r"""
...
︠2b4ccc5d-46c1-4b89-a445-1a66e06efb75︠
import inspect
...
︠66065c82-51bc-4a10-aaf5-3c62d49cc585︠
...
︠5c173d58-ae94-4ef3-b236-9d9e283a43bd︠# Here's how to define a new class:
class MathList(list):
...
︠ba478c16-0610-4b16-893d-eac2149be332︠# There is no "new" keyword like in some languages
v = MathList([1,2,3]);
w = MathList([3,e,pi])
v+w
v*w
...
︠a7fdf5bd-0fea-4a89-ac7d-ad2551d6cc4a︠
my_thing.x = 5
print my_thing.x
type(my_thing.x)
...
︠39305f47-ceda-458d-b1d8-a01ec49bf283︠
...
︠c1914bfc-8488-4840-8ef9-256ab4dbe3c7︠
a[0]
...
︠79efd6ac-9daf-43fc-a78b-4b37d3180200︠
%time
a.det()
...
a.rank
︠9c2de0fd-8c78-4eb5-864e-9a4e685a0390︠class Summable:
    def sum(self):
        s = 0
        for i in self:
            s += i
